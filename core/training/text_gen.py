...
# def rnn_forward(x, y, h_prev, parameters, vocab_size):
#     """
...
#             y = x[1:] + [chars_to_idx["\n"]]
#             # Fwd pass
#             loss, cache = rnn_forward(x, y, h_prev, parameters, vocab_size)
#             # Compute smooth loss
...
def train_generative_model(sents):
    model = defaultdict(ddic)
